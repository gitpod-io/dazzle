...
replace (
	// Distribution v2.7.1 used older logrus-logstash-hook
	// unknown field 'TimestampFormat' in struct literal of type logrustash.LogstashFormatter
	github.com/bshuster-repo/logrus-logstash-hook => github.com/bshuster-repo/logrus-logstash-hook v0.4.1
	// Avoids undefined: letsencrypt.Manager
	github.com/docker/distribution => github.com/docker/distribution v0.0.0-20191216044856-a8371794149d
	// protobuf: corresponds to containerd
	github.com/golang/protobuf => github.com/golang/protobuf v1.3.5
	github.com/hashicorp/go-immutable-radix => github.com/tonistiigi/go-immutable-radix v0.0.0-20170803185627-826af9ccf0fe
	github.com/jaguilar/vt100 => github.com/tonistiigi/vt100 v0.0.0-20190402012908-ad4c4a574305
	// Distribution v2.7.1 used older logrus
	// unknown field 'TimestampFormat' in struct literal of type logrustash.LogstashFormatter
